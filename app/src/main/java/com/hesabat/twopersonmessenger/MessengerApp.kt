...
class MessengerApp : Application(), DefaultLifecycleObserver {
    ...
    override fun onCreate() {
        ...
        // WebRTC burada başladılmır.
        // Yalnız zəng ekranı açıldıqda işə düşəcək.
    ...
    override fun onStop(owner: LifecycleOwner) {
        ...
        p.edit()
            ...
            .putInt(
                ...
                p.getInt("last_seen_message_id", 0)
            )
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val edit = p.edit()
            .putBoolean(
                "return_to_documents",
                p.getBoolean("was_backgrounded", false)
            )

        if (
            delay > 0L &&
            bg > 0L &&
            System.currentTimeMillis() - bg >= delay
        ) {
        ...
        // Köhnə vaxt əsaslı cleared_before filtrini silirik.
        // Telefon və server timezone fərqi yeni mesajları gizlətməsin.
